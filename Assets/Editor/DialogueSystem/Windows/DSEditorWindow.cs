...
namespace DS.Windows
{
    ...
    public class DSEditorWindow : EditorWindow
    {
        ...
        private void AddToolbar()
        {
            ...
            Button clearButton = DSElementUtility.CreateButton("Clear", () => ClearWConfirm());
        ...
        private void ClearWConfirm()
        {
            bool confirm = EditorUtility.DisplayDialog(
            "Are you sure you want to clear the graph?",
            $"This will remove all nodes currently on display without saving them",
            "Yes",
            "Cancel"
            );
