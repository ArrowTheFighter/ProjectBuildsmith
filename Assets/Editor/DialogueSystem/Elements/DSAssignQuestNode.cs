...
namespace DS.Elements
{
    ...
    public class DSAssignQuestNode : DSNode
    {
        ...
        public override void Initialize(string nodeName, DSGraphView dsGraphView, Vector2 position)
        {
            ...
            DialogueType = DSDialogueType.AssignQuest;
        ...
        public override void Draw()
        {
            ...
            Label label = new Label("Assign Quest");
            ...
            TextField itemIDTextField = DSElementUtility.CreateTextArea(quest_id, "Quest ID", callback => quest_id = callback.newValue);
