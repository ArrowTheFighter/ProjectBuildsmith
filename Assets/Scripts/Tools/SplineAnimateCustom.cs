...
namespace UnityEngine.Splines
{
    ...
    /// </summary>
    [AddComponentMenu("Splines/Spline Animate Custom")]
    [ExecuteInEditMode]
    public class SplineAnimateCustom : SplineComponent
    {
        /// <summary>
        ...
        public Method m_Method = Method.Time;
        ...
        void CalculateNormalizedTime(float deltaTime)
        {
            ...
            m_ElapsedTime += deltaTime * (m_Reverse ? -1f : 1f);
